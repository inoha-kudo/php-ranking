...
final class RankedTitleListTest extends TestCase
{
    ...
    public function test_from_with_ranked_titles_having_non_unique_ranks(): void
    {
        ...
        RankedTitleList::from(
            RankedTitle::create(
                $this->rankedTitles[0]->rankingId(),
                $this->rankedTitles[0]->storedAt(),
                $this->rankedTitles[0]->rank(),
                $this->rankedTitles[0]->title(),
            ),
            RankedTitle::create(
                $this->rankedTitles[1]->rankingId(),
    ...
    public function test_to_array(): void
    {
        $this->assertSame(
            [
                [
                    'id' => null,
                    'ranking_id' => $this->rankedTitles[0]->rankingId(),
                ...
                [
                    'id' => null,
                    'ranking_id' => $this->rankedTitles[1]->rankingId(),
